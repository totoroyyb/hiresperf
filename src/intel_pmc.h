...
#define PMC_OCR_WRITE_ESTIMATE_MEMORY_SAPPHIRE                  PMC_ESEL_ENTRY(0x2A, 0x01, 0)
#define PMC_OCR_WRITE_ESTIMATE_MEMORY_RSP_SAPPHIRE              0x0000000FBFF80822
...
#define PMC_OCR_MODIFIED_WRITE_ANY_RESPONSE_SAPPHIRE_FINAL (PMC_OCR_MODIFIED_WRITE_ANY_RESPONSE_SAPPHIRE | PMC_ESEL_USR | PMC_ESEL_OS | \
                        PMC_ESEL_ENABLE)
#define PMC_OCR_WRITE_ESTIMATE_MEMORY_SAPPHIRE_FINAL (PMC_OCR_WRITE_ESTIMATE_MEMORY_SAPPHIRE | PMC_ESEL_USR | PMC_ESEL_OS | \
                        PMC_ESEL_ENABLE)
