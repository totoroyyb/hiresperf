...
#if HRP_USE_COUNTER_COMBINATION
  wrmsrl(MSR_IA32_PERFEVTSEL1, PMC_STALLS_L1D_MISS_ARCH_FINAL);
#else
...
#elif HRP_USE_COUNTER_COMBINATION
  wrmsrl(MSR_IA32_PERFEVTSEL2, PMC_STALLS_L2_MISS_ARCH_FINAL);
#else
...
#elif HRP_USE_COUNTER_COMBINATION
  wrmsrl(MSR_IA32_PERFEVTSEL3, PMC_STALLS_L3_MISS_ARCH_FINAL);
#else
